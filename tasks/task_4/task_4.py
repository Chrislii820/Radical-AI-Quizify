...
#gcloud auth activate-service-account streamlit@gemini-quizify-419318.iam.gserviceaccount.com 
#--key-file="C:\Users\Xin Li\Desktop\Radical AI\Gemini Quizify project\quizzify\mission-quizify\authentication.json" 
#--project=gemini-quizify-419318
...
if __name__ == "__main__":
    ...
    st.title('Embedding Vector Preview')
    st.write('Embedding Vector:', vectors)
